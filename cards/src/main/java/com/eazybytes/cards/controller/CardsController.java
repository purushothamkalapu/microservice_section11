...
public class CardsController {
    ...
    @Operation(
            ...
            description = "Get Build information that is displayed into cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java Version information that is displayed into cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Contact info information that is displayed into cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
