...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get Java Version information that is displayed into loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Contact info information that is displayed into loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
